...
VALID_DEPARTMENTS = {
    "PWD", "Jal Board", "Electricity Board", "Municipal",
    "Health Dept", "Education Dept", "Transport Dept", "General",
}
...
async def generate_insights(complaints: list) -> dict:
    system_prompt = (
